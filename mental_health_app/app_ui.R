...
concl <- tabPanel("Conclusion", 
                  ...
                  p("We also found that depressive disorders are highly prevelant 
                    ...
                    mental illnesses. In addition, children between the age of 0 
                    and 14 are more likely to experience 
                    trauma-related disorders more than other age groups."), 
                  ...
                  crticial thinking."),
                  p("This information in the interactive chart shown below
                  can be used to develop targetted interventions aimed at 
                  improving mental health care towards the marginalized groups."),
                  plotlyOutput("bar")
                  )
